export default {
  ...
  wallet: {
    ...
    instruction_address: 'This is the recommended way to access your wallet and can be used with confidence.</br>You can only view your balance via this option. Please use another option in order to send.</br>If you want to experience our wallet you could use this address to unlock, but could\'t place order, send transfer and do other operations that need private key: 0x750ad4351bb728cec7d639a9511f9d6488f1e259',
    nonce: 'Nonce',
