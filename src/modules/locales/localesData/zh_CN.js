export default {
  ...
  trade: {
    ...
    ring:"环哈希",
    tips_time_to_live: "您希望订单持续有效时间是多久？设置大的有效时间可以让订单在比较长时间内被矿工寻找可匹配订单，提高撮合成功概率。如果设置很小，有可能无法完成撮合。推荐设置大于1小时。",
    tips_lrc_fee: "您订单撮合成功后愿意付给矿工的手续费，按您提交订单规模的千分比计算。因为矿工撮合需要发送以太坊交易花费gas，只有当您订单设置一个合理的比例才会有矿工愿意帮您撮合订单，我们不推荐您修改这个值除非您充分理解这个值得含义。",
    tips_margin_split: "当您没有足够的LRC支付手续费时，您可以设置分润比例来支付手续费，分润和LRC Fee只会被撮合着取其一，我们不推荐您修改这个值除非您充分理解这个值得含义。"
  },
  token: {
    convert_title: "转换",
    amount: "数量",
