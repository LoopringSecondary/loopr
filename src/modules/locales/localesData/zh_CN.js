export default {
  ...
  wallet: {
    ...
    instruction_ledger: '这是推荐的解锁方式，可以放心使用。</br>Ledger 硬钱包可以物理随机产生私钥、存储私钥、独立完成签名运算而不发送私钥到计算机，安全地存储用户的数字资产，杜绝数字资产存储和交易的各种安全风险。',
    ...
    instruction_trezor: '这是推荐的解锁方式，可以放心使用。</br>Trezon硬钱包可以物理随机产生私钥、存储私钥、独立完成签名运算而不发送私钥到计算机，安全地存储用户的数字资产，杜绝数字资产存储和交易的各种安全风险。',
  },
  tokens: {
