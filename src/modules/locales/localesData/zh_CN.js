export default {
  ...
  trades_faq:'交易FAQ',
  trades_faq_content:`
    <div class="fs16 color-black-1 lh30 mt10">
        Q: 交易过程中哪些操作需要花钱？哪些操作不需要花钱？
    </div>
    <div class="fs13 color-black-2 lh30">

        下单：无需支付任何费用，也不冻结任何资产
        <br />
        订单成交后：需要支付订单金额和矿工撮合费（LRC）。成交之后，智能合约会从用户地址里自动扣除对应资产。
        <br />
        订单未成交：无需支付任何费用
        <br />
        ...
        <br />
        有交易额外收益：部分情况下，交易双方可能获得撮合奖励(LRC)
        <br />
        有矿工撮合费：订单成交需要向矿工支付交易撮合费（LRC）
    </div>
    <div class="fs16 color-black-1 lh30 mt10">
        Q: 为什么我的订单成交价比我的卖价更高？或者比我的买价更低？
    </div>
    <div class="fs13 color-black-2 lh30">
        B用户想要以 $1 价格出售LRC
        <br />
        ...
        <br />
        交易的结果是：三方获利 。A用户的实际购买价格更低，B用户的实际出售价格更高，矿工也获得了一定的撮合分润。所有的奖励都是从订单价差里得来的。

    </div>
    <div class="fs16 color-black-1 lh30 mt10">
        Q: 为什么我的订单一直没有成交或者成交速度很慢？
    </div>
    <div class="fs13 color-black-2 lh30">
    ...
    <div class="fs14 color-black-1 lh30 mt10">
        更多问题，敬请期待《路印钱包用户指南》
    </div>
  `,
},
