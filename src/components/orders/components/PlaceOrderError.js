            ...
            if(item.type === 'BalanceNotEnough'){
              return (
                <div className="" key={index}>
                  ...
                  <a className="ml15 color-blue-500" onClick={gotoReceive}>Receive <Icon type="right" /></a>
                  <a className="ml15 color-blue-500" onClick={gotoBuy.bind(this,item.value.symbol)}>Buy <Icon type="right" /></a>
                </div>
              )
