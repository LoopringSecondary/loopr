...
let basicSchemas = {
  ...
  ABI_METHOD: {
    type: 'enum',
    required: true,
    enum: ['cancelOrder', 'cancelAllOrders', 'cancelOrdersByTokenPairs','approve', 'withdraw', 'transfer', 'balanceOf', 'allowance','symbol','name','decimals','bind','unbind','getBindingAddress'],
  },
  RPC_TAG: {
    type: 'enum',
    required: true,
